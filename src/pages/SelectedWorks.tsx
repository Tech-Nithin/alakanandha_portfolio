...
const projects = [
  {
    id: "001",
    title: "Company Expense Tracker Tool",
    stack: "React / Node.js / Supabase / AI Recognition / Redis / CDN",
    description: [
      "Developed a role-based Company Expense Tracker with dedicated dashboards for admins and employees to streamline expense submission, approval, and tracking.",
      "Built leveraging Supabase for database management, authentication, and secure storage, including Supabase Storage to handle receipt uploads.",
      "Implemented an AI-powered chat assistant to provide intelligent insights on expenses and analyze spending patterns.",
      "Designed dynamic dashboards with real-time data visualization and optimized performance using Redis caching for large-scale data fetching and a CDN for low latency."
    ],
    links: { live: "#", code: "#" },
    image: "/Agile_Release.jpg",
    cta: "Live Project"
  },
  {
    id: "002",
    title: "Ready To Collab",
    stack: "React / Node.js / REST APIs / PostgreSQL / Real-Time Messaging / Email Notifications",
    description: [
      "Developed a full-stack platform enabling brand–influencer discovery, matching, and campaign management.",
      "Built with a scalable backend, optimized database queries, and custom content-sharing workflows for deliverable submission and review.",
      "Implemented a real-time messaging system for seamless communication between brands and creators, integrated with email notifications for campaign updates.",
      "Optimized performance to support scalable, multi-user campaign operations."
    ],
    links: { live: "#", code: "#" },
    image: "/AI-Assisted.png",
    cta: "Live Project"
  },
];
...
const SelectedWorks = () => {
  ...
  useEffect(() => {
    ...
    const initTimer2 = setTimeout(calculateAndRender, 800);
